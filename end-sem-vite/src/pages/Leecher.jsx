...
function Leecher(){
    const contents = [
        ...
        {
            id: 10,
            thumbnail: "https://via.placeholder.com/150/800080/FFFFFF?text=Content+10",
            title: "Content 10",
            description: "Description for content 10"
        },
        {
            id: 11,
            thumbnail: "https://via.placeholder.com/150/000080/FFFFFF?text=Content+11",
            title: "Content 11",
            description: "Description for content 11"
        },
        {
            id: 12,
            thumbnail: "https://via.placeholder.com/150/808080/FFFFFF?text=Content+12",
            title: "Content 12",
            description: "Description for content 12"
        },
        {
            id: 13,
            thumbnail: "https://via.placeholder.com/150/FFA500/FFFFFF?text=Content+13",
            title: "Content 13",
            description: "Description for content 13"
        },
        {
            id: 14,
            thumbnail: "https://via.placeholder.com/150/FFC0CB/FFFFFF?text=Content+14",
            title: "Content 14",
            description: "Description for content 14"
        },
        {
            id: 15,
            thumbnail: "https://via.placeholder.com/150/ADD8E6/FFFFFF?text=Content+15",
            title: "Content 15",
            description: "Description for content 15"
        },
        {
            id: 16,
            thumbnail: "https://via.placeholder.com/150/90EE90/FFFFFF?text=Content+16",
            title: "Content 16",
